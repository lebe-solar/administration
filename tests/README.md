...
The included [Playwright](https://playwright.dev/) smoke tests hit the deployed Product Administration web app and confirm the Dashboard, Products, and Manufacturers pages render and can reach the live API.
