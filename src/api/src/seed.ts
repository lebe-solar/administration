...
const offerComponentSeeds = [
    { _id: "service-mounting", name: "Modulaufständerung", quantity: 1, price: 0, descriptionLines: ["Modulmontage und Verkabelung der Module bis zum Wechselrichter", "Leitung 6qmm² inkl. MC4 Stecksystem für mehr Sicherheit"] },
    { _id: "service-surge-protection", name: "Blitzschutz-AC Seitig", quantity: 1, price: 0, descriptionLines: ["Kombiableiter + Überspannungsschutz", "Prüfklasse IEC61643-11 VDE0675-6-11: Typ1+2+3"] },
    { _id: "service-scaffolding", name: "Arbeitsschutzgerüst inkl. Absturzsicherung", quantity: 1, price: 0, descriptionLines: ["Arbeits- und Schutzgerüst gemäß der Unfallverhütungsvorschriften"] },
    { _id: "service-delivery", name: "Lieferung", quantity: 1, price: 0, descriptionLines: ["Lieferung der PV Anlage"] },
    { _id: "service-installation", name: "Montage & Installation", quantity: 1, price: 0, descriptionLines: ["Installation & Verkabelung der Module & Verkabelung des Wechselrichters", "Integration in den Sicherungskasten", "Anschluss und Integration eines Energiespeichers", "Prüfen der Spannung, Dokumentation und Abnahme durch einen unserer Elektriker", "Diese Position ist ein Nachweis der getätigten Arbeitsleistung nach §35a EStG"] },
    { _id: "service-registration", name: "Anmeldung der PV Anlage", quantity: 1, price: 0, descriptionLines: ["Zusammenstellen und Übermittlung der Anlagendaten beim zuständigen Netzbetreiber", "Inbetriebnahme der Anlage"] },
];
    ...
    return [
        {
            ...
            products: { solarModuleId: "MOD-001", solarModuleCount: 24, inverterId: "INV-001", inverterCount: 1, storageId: "STO-001", storageCount: 1 },
            inclusive: [
                ...
                { id: "service-installation", name: "Montage & Installation", quantity: 1, price: 0, descriptionLines: ["Installation & Verkabelung der Module & Verkabelung des Wechselrichters", "Integration in den Sicherungskasten"] },
            ],
            allowChanges: false, status: "Active",
        },
        {
            ...
            products: { solarModuleId: "MOD-003", solarModuleCount: 18, inverterId: "INV-003", inverterCount: 1, storageId: "STO-002", storageCount: 1 },
            inclusive: [
            ...
            allowChanges: true, status: "Active",
        },
        {
            ...
            products: { wallboxId: "WAL-001", wallboxCount: 1 },
            inclusive: [
            ...
            allowChanges: true, status: "Draft",
        },
        {
            ...
            products: { solarModuleId: "MOD-002", solarModuleCount: 32, inverterId: "INV-002", inverterCount: 1, storageId: "STO-003", storageCount: 1, wallboxId: "WAL-002", wallboxCount: 1 },
            inclusive: [
            ...
            allowChanges: false, status: "Hidden",
        },
    ];
}
...
export async function seedIfEmpty(): Promise<void> {
    ...
    await OfferComponentModel.insertMany(offerComponentSeeds);
    await OfferModel.insertMany(offers);

    logger.info(`Seeded ${Object.keys(manufacturerSeeds).length} manufacturers, ${products.length} products, ${offerComponentSeeds.length} offer components, ${offers.length} offers.`);
}
